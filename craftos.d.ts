/** @noSelf */
import Peripherals = peripheral.Peripherals
...
//type TabulationArgs = [] | [colors.Color, string[], ...TabulationArgs]
...
declare const periphemu: {
	 ...
	 * @noSelf */
	create(side: peripheral.Name, type: keyof Peripherals): boolean
